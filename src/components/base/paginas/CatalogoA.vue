  ...
  <div class="contenido-form">
    <div class="formulario">
      <div class="contenedor">
        <div class="fila">
          <div class="columna-12 columna-md-8 columna-lg-4 desplazar-md-2 desplazar-lg-4">
            <div class="fila">
                ...
                <div class="fila">
                  ...
                  <div class="columna-12 columna-md-12 columna-lg-4">
                    <DatePicker id="calFechaVigencia2" v-model="fechaVigencia" input-id="calFechaVigenciaBInput"
                      :show-icon="true" :x="150" :placeholder="t('catalogoA.formato_fecha')" />
                  </div>
                  <div class="columna-12 columna-md-12 columna-lg-4">
        ...
        <div class="contenedor">
          <div class="fila">
            <div class="columna-12 columna-md-8 columna-lg-4 desplazar-md-2 desplazar-lg-4">
              ...
              <div class="relleno-10" />
              <Fieldset :legend="t('catalogoA.seccion_c.titulo_fielset')" :toggleable="true" :x="600">
                <p>
